                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                                <ul class="navbar-nav">
                                    ...
                                    <li><a href="javascrip:void(0);" @click.prevent="showError('Please enter email and zip to continue')" v-cloak class="btn btn-info">Book a Cleaning</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <div class="slider-content">
                            ...
                            <form class="form-wrap" action="booking">
                                @csrf
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <input required v-model="email" type="text" placeholder="Email Address" class="btn-group1">
                                    <input required v-model="zip" type="number" placeholder="Zip Code" class="btn-group2">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <form class="form-wrap mt-5" action="booking.html">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <input required v-model="email" type="email" placeholder="Email Address" class="btn-group1">
                                <input required v-model="zip" type="number" placeholder="Zip Code" class="btn-group2">
                                <button type="submit" class="btn-form">Continue<i class="pe-7s-angle-right"></i></button>
                            </div>
                        </form>
