            ...
            <form action="#">
                ...
                <div class="preferences">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-4 sm-box">
                                <div class="styled-radio">
                                    <input v-model="cleaning.selected" value="STANDARD" type="radio" id="option-one" name="selector">
                                    <label for="option-one">STANDARD</label>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-4 sm-box">
                                <div class="styled-radio">
                                    <input v-model="cleaning.selected" type="radio" value="DEEP" id="option-two" name="selector">
                                    <label for="option-two">DEEP</label>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-4 sm-box">
                                <div class="styled-radio">
                                    <input v-model="cleaning.selected" type="radio" value="MOVE IN/OUT" id="option-three" name="selector">
                        ...
                        <div class="row">
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="time" value="One Time" type="radio" id="one-time" name="selector1">
                                    <label for="one-time">ONE TIME</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="time" value="Weekly" type="radio" id="weekly" name="selector1">
                            ...
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="time" value="BI-Weekly" type="radio" id="bi-weekly" name="selector1">
                                    <label for="bi-weekly">BI-WEEKLY</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="time" value="Monthly" type="radio" id="monthly" name="selector1">
                            ...
                            <div class="preference-quantity">
                                <div class="counter js-counter">
                                    ...
                                    <div class="counter__item counter__item--center">
                                        <input v-model="home.bedrooms" class="counter__value js-counter-value" type="text" value="1" disabled="disabled" tabindex="-1" min="0" max="10" required />
                                    </div>
                                    <div class="counter__item">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="preference-quantity">
                                <div class="counter js-counter">
                                    ...
                                    <div class="counter__item counter__item--center">
                                        <input v-model="home.bathrooms" class="counter__value js-counter-value" type="text" value="1" disabled="disabled" tabindex="-1" min="0" max="10" required />
                                    </div>
                                    <div class="counter__item">
                                        <a class="counter__plus js-counter-btn fa fa-plus" aria-hidden="true" data-action="plus"></a>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <ul class="topics d-flex flex-wrap">
                                    <li><input type="checkbox" id="box-1" />
                                        <label for="box-1"><svg class="checked-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 463 463" style="enable-background:new 0 0 463 463;" xml:space="preserve" width="65px" height="65px">
                                                <g>
                                                    <g>
                                                        <g>
                                                            <g>
                                            ...
                                            </svg> CLEAN OVEN</label>
                                    </li>
                                    <li><input type="checkbox" id="box-2" />
                                        <label for="box-2"><svg class="checked-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="65px" height="65px">
                                                <g>
                                                    <g>
                                                        <g>
                                    ...
                                    <li><input type="checkbox" id="box-3" checked />
                                        <label for="box-3"><svg class="checked-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 439.5 439.5" style="enable-background:new 0 0 439.5 439.5;" xml:space="preserve" width="65px" height="65px">
                                                <g>
                                                    <g>
                                    ...
                                    <li><input type="checkbox" id="box-4" />
                                        <label for="box-4"><svg class="checked-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 511 511" style="enable-background:new 0 0 511 511;" xml:space="preserve" width="65px" height="65px">
                                                <g>
                                                    <g>
                    ...
                    <div class="preference-radio mt-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea v-model="details" class="optinal-textarea"></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="preference-radio mt-4">
                                ...
                                <div class="preference-quantity houres">
                                    <div class="counter js-counter">
                                        ...
                                        <div class="counter__item counter__item--center">
                                            <input class="form-control" type="number" v-model="hour" tabindex="-1" />
                                        </div>
                                        <div class="counter__item">
                                            <a class="counter__plus js-counter-btn fa fa-plus" aria-hidden="true" data-action="plus"></a>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-5">
                                        <div class="input-group input-append date">
                                            <datepicker :disabled-dates="state.disabledDates" :bootstrap-styling="true" placeholder="Please Choose a Date" v-model="date"></datepicker>
                    ...
                    <div class="preference-radio mt-4">
                        ...
                        <div class="row">
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="timer" value="7:00 AM" type="radio" id="timer1" name="selector2">
                                    <label for="timer1">7:00 AM</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="timer" value="9:00 AM" type="radio" id="timer2" name="selector2">
                                    <label for="timer2">9:00 AM</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2 radio-disable">
                                    <input v-model="timer" value="11:00 PM" type="radio" id="timer3" name="selector2" disabled>
                                    <label for="timer3" disabled>11:00 PM</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="timer" value="1:00 PM" type="radio" id="timer4" name="selector2">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="timer" value="3:00 PM" type="radio" id="timer5" name="selector2">
                                    <label for="timer5">3:00 PM</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="timer" value="5:00 PM" type="radio" id="timer6" name="selector2">
                                    <label for="timer6">5:00 PM</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2">
                                    <input v-model="timer" value="7:00 PM" type="radio" id="timer7" name="selector2">
                                    <label for="timer7">7:00 PM</label>
                                </div>
                            </div>
                            <div class="col-md-3 sm-box">
                                <div class="styled-radio styled-radio2 radio-disable">
                                    <input v-model="timer" value="9:00 PM" type="radio" id="timer8" name="selector2" disabled>
                    ...
                    <div class="preference-radio mt-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-9">
                                <div class="card-details">
                                    <input v-model="adress" type="text" placeholder="Your Full Address" class="card-number">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card-details">
                                    <input v-model="zip" type="number" placeholder="10023" class="card-number">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
        ...
        <div class="col-md-4 set-sm-fit">
            <div data-toggle="affix">
                ...
                <div class="fesilities">
                    <ul>
                        <li><i :class="addTypeIcon ? '' : 'fa fa-paint-brush'" aria-hidden="true"></i>
                            <p>{{ cleaning.selected }}</p>
                        </li>
                        <li><i :class="addTimerIcon ? '' : 'fa fa-calendar'" aria-hidden="true"></i>
                            <p>{{date | moment}} {{ timer }}</p>
                        </li>
                        <li><i :class="addHourIcon ? '' : 'fa fa-clock-o'" aria-hidden="true"></i>
                            <p>{{ hour }}</p>
                        </li>
                        <li><i :class="addTimeIcon ? '' : 'fa fa-refresh'" aria-hidden="true"></i>
                            <p>{{ time }}</p>
                        </li>
                        <li><i :class="addAdressIcon ? '' : 'fa fa-map-marker'" aria-hidden="true"></i>
                            <p>{{ adress }} {{ zip }}</p>
                        </li>
                    </ul>
  ...
  components: {
    ...
    data() {
        ...
        computed: {
            ...
            splitedList(){
                let newArr = [...this.date]
                newArr.map(el => {
                    return el.codes = el.codes.split('T')
                })
                return newArr
            }
        },
