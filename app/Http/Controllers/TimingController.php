...
class TimingController extends Controller
{
    ...
    public function TimingList(Request $request){
        ...
        $timing = Timing::orderBy('id')->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            return response()->json(['status'=>'success','message'=>'Timing Added Successfully !']);
        }
        catch(\Exception $e)
        {
    ...
    public function update(Request $request, $id)
    {
        try{
            ...
            return response()->json(['status'=>'success','message'=>'Timing Updated Successfully !']);
        }
        catch(\Exception $e)
        {
